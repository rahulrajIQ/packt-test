...
#choices - reputation,creation,modified,name
parser.add_argument("-sort_by", default="reputation")
...
df= pd.concat([df.drop(['badge_counts','collectives'], axis=1), df['badge_counts'].apply(pd.Series)], axis=1)
print(df)
